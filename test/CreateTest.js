...
describe('/POST Create Post', function() {
    it('It should have the same ID', function() {
        ...
        MongoClient.connect(url, function(err, db) {
            ...
            var dbo = db.db("myFirstDatabase");
            // Create the type of object you would like to create e.g. 'Profile', 'User', 'Comment' ...
            var myobj = { text: "A_post", name: "add@hotmail.com", avatar: "128" }
                // Set the string for the collection (Only for count)
...
describe('/POST Create Comment', function() {
    it('There should be a comment with every answer', function() {
        ...
        MongoClient.connect(url, function(err, db) {
            ...
            var dbo = db.db("myFirstDatabase");
            // Create the type of object you would like to create e.g. 'Profile', 'User', 'Comment' ...
            // adjusted for comment checking???? 
            var myobj = { answer: db.feed.find(), comment: db.feed.find() }
                // Set the string for the collection (Only for count)
